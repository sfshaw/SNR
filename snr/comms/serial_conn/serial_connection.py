...
from snr.comms.serial_conn.packet import *
from snr.comms.serial_conn.serial_finder import SerialFinder
...
import serial
from serial.serialutil import SerialException, SerialBase


class SerialConnection(SynchronousEndpoint):
    ...
    def handle_serial_com(self, t: Task, k: TaskId):
