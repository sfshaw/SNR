...
#         connection
#         This timeout should be very long to allow the server to open its
#         socket before the client gives up on connecting to it.
#     '''
...
#     SERIAL_RETRY_WAIT_S = 0.5  # Time to wait before retrying
#     SERIAL_TIMEOUT = 4
