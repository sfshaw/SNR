...
#             parent,
#             name,
#             max_tick_rate_hz=parent.settings.CONTROLLER_INIT_TICK_RATE)
...
#         self.joystick_data: Dict[str, Any] = {}
...
#         else:
#             self.err(
#                 "Controller not found but not required, simulating input")
...
#         self.dbg("Storing data with key: {}", [self.name])
#         self.dbg("\n\tController data:\n\t {}", [controls_dict])
#         self.store_data(controls_dict)

#     def print_data(self, d: Dict[str, Any]):
#         for val in d:
#             print(str(val) + ":\t" + str(d[val]))

#     def check_trigger_zeroed(self,
#                              data: Dict[str, Any],
#                              ) -> Dict[str, Any]:
...
#     def map_input(self, key: str, value: Any) -> Tuple[str, Any]:
...
#     def cast(self, value: Any, T: Union[Type[T], None]) -> T:
#         if T is None:
#             return value
#         if T is int:
#             return int(value)
...
#                         int((float(value) * -4) + 2))
#             self.dbg("Trying to cast {}: {} as tuple",
#                      [type(value), value])
#         return value
...
#         """
#         if (not self.settings.USE_CONTROLLER) or \
#                 self.settings.SIMULATE_INPUT:
#             return {}
...
#     def simulate_input(self) -> Dict[str, Any]:
...
#         self.dbg("Simulated control input:\n{}",
#                  [sim_data])
#         return sim_data
...
#     s = "Warning: disconnecting the controller will crash the program"
#     print(s)
